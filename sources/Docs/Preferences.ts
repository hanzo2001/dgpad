...
$P.size.touchfactor = 1 * w.$SCALE;
$P.size.point = 6 * w.$SCALE;
$P.size.list = 1 * w.$SCALE;
$P.size.pointborder = 2 * w.$SCALE;
$P.size.line = 1 * w.$SCALE;
$P.size.angle = 4 * w.$SCALE;
$P.size.fixedangle = 1 * w.$SCALE;
$P.size.expression = 7 * w.$SCALE;
$P.size.expression_cursor = 10 * w.$SCALE;
$P.size.dash = [6, 10];
...
$P.sizefactor = {};
$P.sizefactor.expression = 1 * w.$SCALE;
$P.sizefactor.expression_cursor = 1 * w.$SCALE;

$P.oversizefactor = {};
$P.oversizefactor.expression = 1 * w.$SCALE;
$P.oversizefactor.expression_cursor = 1 * w.$SCALE;

$P.fontsize = {};
$P.fontsize.point = 30 * w.$SCALE;
$P.fontsize.segment = 24 * w.$SCALE;
$P.fontsize.angle = 24 * w.$SCALE;
$P.fontsize.fixedangle = 24 * w.$SCALE;
$P.fontsize.expression = 24 * w.$SCALE;
$P.fontsize.blockly_button = 24 * w.$SCALE;
$P.font = "Verdana";
$P.fontmargin = 5;
...
$P.tool = {};
$P.tool.size = 50 * w.$SCALE;
$P.tool.touchfactor = 1.2;
$P.tool.gap = 5 * w.$SCALE;
$P.tool.marginV = 30 * w.$SCALE;

$P.controlpanel = {};
$P.controlpanel.size = 42 * w.$SCALE;
